...
export default function SignInPage({ onBack, onNext }) {
  ...
  <path fill="#fff" d="M12 19h6v17h-6zM15 16.5a3 3 0 1 1 0-6 3 3 0 0 1 0 6zM22 19h5.5v2.5h.1C28.4 19.9 30.4 19 32.5 19 37.5 19 38 22.3 38 26.6V36h-6v-8.3c0-2-.1-4.5-2.8-4.5-2.8 0-3.2 2.1-3.2 4.4V36H22V19z"/>
</svg>
